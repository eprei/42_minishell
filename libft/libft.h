...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/27 09:13:35 by olmartin          #+#    #+#             */
/*   Updated: 2022/02/23 16:31:57 by olmartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_printf_p(const long long p);
int		ft_printf_x_upper(const long nb);
int		ft_printf_x(const long nb);
